...
const Container = styled.View`margin-bottom: 40px;`;
...
const IconsContainer = styled.View`
	...
	flex-direction: row;
`;
const IconContainer = styled.View`margin-top: 10px;`;
const InfoContainer = styled.View`padding: 10px;`;
const Caption = styled.Text`margin: 5px 0px;`;
	...
	return (
		<Container>
			...
			<Swiper
				...
				paginationStyle={{ position: 'absolute', bottom: 'negative integer' }}
