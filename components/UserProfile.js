...
const ProfileStats = styled.View`flex-direction: row;`;
...
const Bold = styled.Text`font-weight: 600;`;
...
const UserProfile = ({ avatar, postsCount, followersCount, followingCount, bio, fullName }) => (
	<View>
		<ProfileHeader>
